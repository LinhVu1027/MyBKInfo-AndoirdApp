...
public class TestPointActivity extends SingleFragmentActivity {
    ...
    public static Intent newIntent(Context packageContext, String mssv) {
        Intent i = new Intent(packageContext, TestPointActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return TestPointFragment.newInstance(mssv);
    }
}
